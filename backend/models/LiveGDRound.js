...
const aiParticipantSchema = new mongoose.Schema(
  {
    ...
    personality: { type: String, default: "Balanced" },
...
const liveGDMessageSchema = new mongoose.Schema(
  {
    speaker: { type: String, enum: ["user", "ai", "system"], default: "user" },
...
const liveGDRoundSchema = new mongoose.Schema(
  {
    ...
    topic: { type: String, default: "Impact of AI on Jobs" },
    difficulty: { type: String, default: "Beginner" },
    company: { type: String, default: "General" },

    inviteCode: { type: String, unique: true, sparse: true, index: true, default: null },
    meetingCode: { type: String, unique: true, sparse: true, index: true, default: null },
    ...
    pendingParticipants: { type: [participantSchema], default: [] },
    aiParticipants: { type: [aiParticipantSchema], default: [] },

    messages: { type: [liveGDMessageSchema], default: [] },
    ...
    improvedResponse: { type: String, default: "" },
